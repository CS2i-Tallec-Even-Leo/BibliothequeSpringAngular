  ...
  initialize(): void {
    this.apiService
      ...
      .pipe(
        ...
        tap(() =>
          console.log(
            "[SEED] Departements/Villes OK, insertion auteurs/livres...",
          ),
        ),
        switchMap(() =>
          forkJoin<SeedInsertResult>([
            ...
            this.apiService
              .createEtudiant({
                ...
                nom: "Bernard",
                prenom: "Sophie",
                adresse: "23 rue des Fleurs, Paris",
                codeVille: "75001",
                caution: 0,
            ...
            this.apiService
              .createEtudiant({
                ...
                nom: "Lopez",
                prenom: "Antoine",
                adresse: "42 bd de la Republique, Lyon",
                codeVille: "69001",
                caution: 0,
            ...
            this.apiService
              .createParticulier({
                ...
                nom: "Petit",
                prenom: "Jean",
                adresse: "14 place du Marche, Lyon",
                codeVille: "69001",
                caution: 0,
              })
      ...
      .subscribe((results: SeedInsertResult | null) => {
        ...
        console.log(
          `[SEED] Termine: ${ok} insertions reussies, ${fail} echecs.`,
        );
      });
  }
}
